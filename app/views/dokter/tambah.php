...
<body class="flex min-h-screen overflow-hidden p-10 bg-slate-50">
    ...
    <h2 class="text-2xl font-black text-slate-800 mb-6">Tambah Tenaga Medis</h2>
    <form action="<?= BASEURL ?>/admin/dokter/store" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-5">
    <div class="md:col-span-2">
        <label class="text-[10px] font-black text-slate-400 uppercase">Nama Dokter</label>
        <input type="text" name="nama_dokter" required class="w-full px-6 py-4 bg-slate-50 rounded-[20px] outline-none">
    </div>
    <div>
        <label class="text-[10px] font-black text-slate-400 uppercase">Nomor STR</label>
        <input type="text" name="no_str" class="w-full px-6 py-4 bg-slate-50 rounded-[20px] outline-none">
    </div>
    <div>
        <label class="text-[10px] font-black text-slate-400 uppercase">Spesialisasi</label>
        <input type="text" name="spesialisasi" class="w-full px-6 py-4 bg-slate-50 rounded-[20px] outline-none">
    </div>
    <div>
        <label class="text-[10px] font-black text-slate-400 uppercase">Email Resmi</label>
        <input type="email" name="email_resmi" class="w-full px-6 py-4 bg-slate-50 rounded-[20px] outline-none">
    </div>
    <div>
        <label class="text-[10px] font-black text-slate-400 uppercase">Ruangan Praktek</label>
        <input type="text" name="ruangan_praktek" class="w-full px-6 py-4 bg-slate-50 rounded-[20px] outline-none">
    </div>
    <button type="submit" class="md:col-span-2 py-4 bg-blue-900 text-white rounded-[20px] font-bold">SIMPAN DATA</button>
</form>
</div>
    </main>
